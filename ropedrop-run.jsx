...
const EVENTS = [
  ...
  { id: "birthday", land: "Main Street", park: "dl", kind: "good", when: "day", w: 4, title: "Free celebration button",
  ...
  { id: "cocoa", land: "Main Street", from: 1020, to: 1500, park: "dl", kind: "good", when: "day", w: 6, title: "Hot chocolate on Main Street",
  ...
  { id: "wharf", land: "San Fransokyo", park: "dca", kind: "good", when: "day", w: 7, title: "The sourdough smells incredible",
  ...
  { id: "carsgold", park: "dca", kind: "good", when: "day", w: 6, title: "Cars Land at golden hour",
    ...
    joy: 12, comfort: 4 },
  { id: "seagull", land: "Pixar Pier", park: "dca", kind: "bad", when: "day", w: 6, title: "A gull took your churro",
  ...
  { id: "dl_lincoln", after: ["lincoln"], park: "dl", kind: "good", when: "day", w: 5, title: "Great Moments to yourself",
  ...
  { id: "dl_piano", land: "Main Street", park: "dl", kind: "good", when: "day", w: 5, title: "The Coke Corner pianist takes your request",
    text: "Ragtime, at volume, with a wink. He plays it twice because you sang along badly the first time.",
    joy: 9, minutesLost: 10 },
  { id: "dl_skipper", after: ["jungle"], park: "dl", kind: "good", when: "day", w: 6, title: "Your Jungle Cruise skipper is on form",
    text: "Every pun lands. The boat is in bits. You'd pay to see it again.",
    joy: 11 },
  { id: "dl_hatbox", after: ["mansion"], park: "dl", kind: "good", when: "day", w: 4, title: "The Hatbox Ghost was working",
    text: "His head vanished and reappeared exactly on cue, and the couple behind you audibly gasped.",
    joy: 9 },
  { id: "dl_wheelhouse", after: ["twain", "columbia"], park: "dl", kind: "good", when: "day", w: 3, title: "Invited up to the wheelhouse",
  ...
  { id: "dl_walt", land: "Main Street", from: 1140, to: 1500, park: "dl", kind: "good", when: "day", w: 3, title: "The light is on in Walt's apartment",
    text: "Above the Fire Station, still burning. You stand and look at it for longer than you meant to.",
    joy: 10 },
  { id: "dl_engineer", after: ["railroad", "rr_nos", "rr_toon", "rr_tom"], from: 480, to: 660, park: "dl", kind: "good", when: "day", w: 4, title: "The engineer waved you into the cab",
    text: "A slow lap of the park from the footplate of a hundred-year-old locomotive.",
    joy: 14, energy: 6, comfort: 6, minutesLost: 20 },
  { id: "dl_partners", land: "Main Street", park: "dl", kind: "good", when: "day", w: 4, title: "Partners with nobody in the way",
    text: "A gap in the crowd, the castle behind, and a stranger who actually knows how to take a photo.",
    joy: 10 },
  { id: "dl_smallworld_clock", after: ["smallworld"], park: "dl", kind: "good", when: "day", w: 4, title: "The clock struck as you arrived",
    text: "The whole face opens up and the parade of hours goes by. Perfect timing, entirely by accident.",
    joy: 8 },
  { id: "dl_trooper", land: "Galaxy's Edge", park: "dl", kind: "good", when: "day", w: 5, title: "A Stormtrooper decided you looked suspicious",
    text: "Two minutes of being interrogated in front of a delighted crowd. You held up well.",
    joy: 11 },
  { id: "dl_frontrow_pirates", after: ["pirates"], park: "dl", kind: "good", when: "day", w: 5, title: "Front row on Pirates",
    text: "You take the drop full in the face and come up laughing.",
    joy: 9, comfort: -3 },
  { id: "dl_backrow_thunder", after: ["thunder"], park: "dl", kind: "good", when: "day", w: 5, title: "Back row on Big Thunder",
    text: "The last car whips through the turns like it's trying to lose you.",
    joy: 10 },
  { id: "dl_monorail_nose", park: "dl", kind: "good", when: "day", w: 4, title: "Front of the monorail",
    text: "The cast member opens the nose cone and you get the pilot's view all the way to Downtown Disney.",
    joy: 12, energy: 5, comfort: 8, minutesLost: 14 },
  { id: "dl_tiki_preshow", after: ["tiki"], park: "dl", kind: "good", when: "day", w: 3, title: "You caught the Tiki Room preshow",
    text: "Nobody watches the birds outside. You did, and it's the best two minutes in Adventureland.",
    joy: 6, comfort: 4 },
  { id: "dl_gallery", land: "Main Street", park: "dl", kind: "good", when: "day", w: 3, title: "Something new in the Disney Gallery",
    text: "Original concept art you'd never seen, and an empty room to look at it in.",
    joy: 7, comfort: 8, minutesLost: 12 },
  { id: "dl_savi", land: "Galaxy's Edge", park: "dl", kind: "good", when: "day", w: 3, title: "You watched someone build a lightsaber",
    text: "You didn't book it. Standing at the back of Savi's for the reveal was free and nearly as good.",
    joy: 8, minutesLost: 10 },
  { id: "dl_yeti", after: ["matterhorn"], park: "dl", kind: "good", when: "day", w: 4, title: "The Yeti got you",
    text: "You knew it was coming. You jumped anyway. So did everyone else in the bobsled.",
    joy: 8 },
  { id: "dl_dolewhip_walkup", after: ["dolewhip"], park: "dl", kind: "good", when: "day", w: 4, title: "No line at the Dole Whip window",
    text: "Unheard of. You get one immediately and feel like you've beaten the system.",
    joy: 8, fuel: 16, comfort: 7, money: -8 },
  { id: "dl_castle_swans", land: "Fantasyland", park: "dl", kind: "good", when: "day", w: 3, title: "The swans are out by the castle",
    text: "Slow, unbothered, and completely uninterested in the photograph you're trying to take of them.",
    joy: 6, comfort: 3, minutesLost: 8 },
  { id: "dl_toontown_gag", land: "Toontown", park: "dl", kind: "good", when: "day", w: 3, title: "You found a gag nobody else was pulling",
    text: "Half of Toontown is interactive and most people walk straight past it.",
    joy: 7 },
  { id: "dl_indy_frontseat", after: ["indy"], park: "dl", kind: "good", when: "day", w: 4, title: "Front seat on Indiana Jones",
    text: "Every near miss lands properly from there, and the boulder is genuinely alarming.",
    joy: 10 },
  { id: "dl_orbitor", after: ["orbitor"], from: 1080, to: 1320, park: "dl", kind: "good", when: "day", w: 3, title: "Astro Orbitor at the right moment",
  ...
  { id: "dl_mainstreet_window", land: "Main Street", from: 480, to: 720, park: "dl", kind: "good", when: "day", w: 3, title: "You read the windows on Main Street",
  ...
  { id: "dl_scrim", park: "dl", kind: "bad", when: "start", w: 4, title: "There's scrim on the castle",
    ...
    joy: -8 },
  { id: "dl_roped", land: "Main Street", from: 1080, to: 1290, park: "dl", kind: "bad", when: "day", w: 6, title: "The parade route has you trapped",
  ...
  { id: "dl_smallworld_stop", after: ["smallworld"], park: "dl", kind: "bad", when: "day", w: 5, title: "The boats have backed up",
    text: "You're stopped inside, in front of one animatronic, listening to that song at close range.",
    joy: -7, comfort: -5, minutesLost: 12 },
  { id: "dl_teacups", after: ["teacups"], park: "dl", kind: "bad", when: "day", w: 4, title: "Someone spun the teacup too hard",
    text: "You didn't want it that fast and your stomach is still catching up.",
    joy: -4, energy: -6, fuel: -8 },
  { id: "dl_strollers", land: "Fantasyland", park: "dl", kind: "bad", when: "day", w: 5, title: "A wall of strollers in Fantasyland",
    text: "Nothing is moving. There is no way through and no way round.",
    joy: -5, energy: -4, comfort: -5, minutesLost: 8 },
  { id: "dl_ge_trek", land: "Galaxy's Edge", park: "dl", kind: "bad", when: "day", w: 5, title: "The walk back from Galaxy's Edge",
  ...
  { id: "dl_toontown_sun", land: "Toontown", from: 660, to: 1020, park: "dl", kind: "bad", when: "day", w: 4, title: "Toontown is a sun trap",
    text: "No shade anywhere and everything is painted to reflect. It's ten degrees hotter in here.",
    joy: -3, energy: -5, comfort: -13 },
  { id: "dl_pirates_soaked", after: ["pirates"], park: "dl", kind: "bad", when: "day", w: 4, title: "You got the wet seat on Pirates",
    text: "Front left. There is always one and today it was yours.",
    joy: -3, comfort: -12 },
  { id: "dl_hat", after: ["thunder"], park: "dl", kind: "bad", when: "day", w: 3, title: "Your hat went over the side of Big Thunder",
    text: "They'll get it back at the end of the day. It is not the end of the day.",
    joy: -6 },
  { id: "dl_mintjulep_out", land: "New Orleans Sq.", park: "dl", kind: "bad", when: "day", w: 3, title: "They're out of beignets",
    text: "You walked all the way to New Orleans Square for them, too.",
    joy: -7, energy: -4, minutesLost: 10 },
  { id: "dl_tomorrowland_glare", land: "Tomorrowland", from: 720, to: 1020, park: "dl", kind: "bad", when: "day", w: 4, title: "Tomorrowland at two in the afternoon",
    text: "All that white concrete and metal, throwing the sun straight back at you.",
    joy: -3, energy: -4, comfort: -11 },
  { id: "dl_gum", land: "Main Street", park: "dl", kind: "bad", when: "day", w: 3, title: "Gum, on Main Street, on your shoe",
    text: "They don't even sell it here. Somebody brought that in deliberately.",
    joy: -5, minutesLost: 8 },
  { id: "dl_bench", land: "Main Street", from: 660, to: 1080, park: "dl", kind: "bad", when: "day", w: 4, title: "Every bench in the hub is taken",
  ...
  { id: "dl_photo_fail", park: "dl", kind: "bad", when: "day", w: 3, title: "The PhotoPass shot didn't take",
    text: "You queued, posed, and the photographer's tablet had already lost it.",
    joy: -6, minutesLost: 8 },
  { id: "dl_matterhorn_rough", after: ["matterhorn"], park: "dl", kind: "bad", when: "day", w: 4, title: "The Matterhorn found every seam in the track",
    text: "Your back knows exactly how old that ride is now.",
    joy: -3, energy: -8, comfort: -9 },
  { id: "dl_singalong", park: "dl", kind: "bad", when: "day", w: 3, title: "Someone is singing along to everything",
    ...
    joy: -6 },
  { id: "dl_frontierland_dust", land: "Frontierland", from: 660, to: 1020, park: "dl", kind: "bad", when: "day", w: 3, title: "The dust in Frontierland",
    text: "It's in your eyes, your drink and the back of your throat.",
    joy: -3, comfort: -8 },
  { id: "dl_haunted_delay", after: ["mansion"], park: "dl", kind: "bad", when: "day", w: 3, title: "Stuck in the stretching room",
    text: "Something's wrong with the doors. Six minutes in a room with no windows and no way out.",
    joy: -4, comfort: -7, minutesLost: 6 },
  { id: "dl_castle_crowd", land: "Fantasyland", park: "dl", kind: "bad", when: "day", w: 5, title: "You can't get near the castle",
    text: "Three separate photo sessions and a tour group, all in the one spot everyone wants.",
    joy: -4, minutesLost: 10 },
  { id: "dl_railroad_full", after: ["railroad", "rr_nos", "rr_toon", "rr_tom"], from: 900, to: 1440, park: "dl", kind: "bad", when: "day", w: 3, title: "The train left without you",
    text: "Full at Main Street. The next one is twenty minutes and you can walk it faster.",
    joy: -4, energy: -4, minutesLost: 8 },
  { id: "dca_racers_win", after: ["racers"], park: "dca", kind: "good", when: "day", w: 6, title: "Your car won the race",
    text: "Down the last straight side by side and yours pulled ahead. The whole car cheered.",
    joy: 12 },
  { id: "dca_soarin_front", after: ["soarin"], park: "dca", kind: "good", when: "day", w: 5, title: "Front row on Soarin'",
    text: "No feet dangling in your eyeline for once. It's a completely different ride.",
    joy: 10, comfort: 6 },
  { id: "dca_grizzly_dry", after: ["grizzly"], park: "dca", kind: "good", when: "day", w: 4, title: "You came off Grizzly bone dry",
    text: "Everyone else in the raft is soaked and cannot understand how you managed it.",
    joy: 9 },
  { id: "dca_incredi_front", after: ["incredicoaster"], park: "dca", kind: "good", when: "day", w: 5, title: "Front car on Incredicoaster",
    text: "That first launch with nothing in front of you is the best five seconds in the park.",
    joy: 11 },
  { id: "dca_carsland_neon", land: "Cars Land", from: 1140, to: 1440, park: "dca", kind: "good", when: "day", w: 5, title: "Radiator Springs at lighting time",
    text: "The whole street comes on at once, the neon hums, and everyone stops walking.",
    joy: 14, comfort: 4, minutesLost: 10 },
  { id: "dca_luigi", after: ["luigi"], park: "dca", kind: "good", when: "day", w: 4, title: "Luigi's cars actually dance",
    text: "You forget it's a ride and just watch them work. The song is in your head now regardless.",
    joy: 7 },
  { id: "dca_mater", after: ["mater"], park: "dca", kind: "good", when: "day", w: 3, title: "You got the good Mater song",
    text: "There are several and this is the one worth having.",
    joy: 6 },
  { id: "dca_web_highscore", after: ["webslingers"], park: "dca", kind: "good", when: "day", w: 5, title: "You topped the car on WEB SLINGERS",
    text: "Both arms aching, entirely worth it, and you have the screen to prove it.",
    joy: 11, energy: -5 },
  { id: "dca_spidey", after: ["spiderman"], park: "dca", kind: "good", when: "day", w: 5, title: "The Spider-Man stunt landed clean",
    text: "Straight up the side of the building and over. Nobody quite believes what they've seen.",
    joy: 10 },
  { id: "dca_avengers_char", land: "Avengers Campus", park: "dca", kind: "good", when: "day", w: 4, title: "Loki held court in Avengers Campus",
    text: "Fully in character, entirely unbothered by the queue forming, and very funny.",
    joy: 11, minutesLost: 10 },
  { id: "dca_bakery_sample", after: ["bakery"], park: "dca", kind: "good", when: "day", w: 5, title: "Free sourdough at the end of the tour",
    text: "Still warm. You take two and nobody says anything.",
    joy: 7, fuel: 12, comfort: 3 },
  { id: "dca_ghirardelli", after: ["ghirardelli"], park: "dca", kind: "good", when: "day", w: 5, title: "The chocolate square is still free",
    text: "Walk in, take one, walk out. Best value in the resort.",
    joy: 7, fuel: 8 },
  { id: "dca_lamplight_view", after: ["lamplight"], park: "dca", kind: "good", when: "day", w: 4, title: "A table on the Lamplight balcony",
  ...
  { id: "dca_woc_rail", after: ["woc"], from: 1140, to: 1350, park: "dca", kind: "good", when: "day", w: 5, title: "Front rail for World of Color",
  ...
  { id: "dca_trolley", park: "dca", kind: "good", when: "day", w: 4, title: "The Red Car Trolley came along",
    text: "You weren't waiting for it, but you're not going to walk when that's an option.",
    joy: 7, energy: 8, comfort: 6, minutesLost: 8 },
  { id: "dca_animation", after: ["animation"], park: "dca", kind: "good", when: "day", w: 4, title: "You drew a passable Mickey",
    text: "Twenty minutes in the cool and dark, and you're taking the paper home.",
    joy: 9, energy: 8, comfort: 14, minutesLost: 20 },
  { id: "dca_crush", after: ["turtletalk"], park: "dca", kind: "good", when: "day", w: 5, title: "Crush picked you out",
    text: "A full conversation in front of a hundred people. You did not have anything clever ready.",
    joy: 12, comfort: 10 },
  { id: "dca_geyser", after: ["grizzly"], park: "dca", kind: "good", when: "day", w: 4, title: "The Grizzly geyser caught the raft behind",
    text: "Not you. Them. You watched it happen and it was magnificent.",
    joy: 8 },
  { id: "dca_boardwalk_win", after: ["boardwalk"], park: "dca", kind: "good", when: "day", w: 3, title: "You actually won on the Boardwalk",
    text: "A stuffed thing bigger than your bag, which you will now carry for nine hours.",
    joy: 10, energy: -4, money: -12 },
  { id: "dca_pier_sunset", land: "Pixar Pier", from: 1080, to: 1260, park: "dca", kind: "good", when: "day", w: 5, title: "Sunset behind Pixar Pier",
    text: "The wheel and the coaster in silhouette, and the whole lagoon gone gold.",
    joy: 11, comfort: 4 },
  { id: "dca_philhar", after: ["philhar"], park: "dca", kind: "good", when: "day", w: 3, title: "PhilharMagic in an empty theatre",
    text: "Cool, dark, forty-five people in a room that seats hundreds.",
    joy: 8, energy: 9, comfort: 15, minutesLost: 16 },
  { id: "dca_zephyr", after: ["zephyr"], park: "dca", kind: "good", when: "day", w: 3, title: "Golden Zephyr at the right hour",
    text: "It only runs when the wind is calm, and the view out over the water is worth the wait.",
    joy: 7, comfort: 4 },
  { id: "dca_wharf_short", land: "San Fransokyo", park: "dca", kind: "good", when: "day", w: 4, title: "No queue at the wharf",
    text: "Every counter open at once. You eat properly for the first time today.",
    joy: 8, fuel: 26, comfort: 8, money: -17, minutesLost: 18 },
  { id: "dca_monsters_taxi", after: ["monsters"], park: "dca", kind: "good", when: "day", w: 3, title: "The taxi driver knew your name",
    text: "They read it off your bag and worked it into the spiel. Small thing, well done.",
    joy: 7 },
  { id: "dca_pier_gull_standoff", land: "Pixar Pier", park: "dca", kind: "good", when: "day", w: 3, title: "You out-stared a gull",
    text: "It considered your churro at length, thought better of it, and left.",
    joy: 6 },
  { id: "dca_split", after: ["racers"], park: "dca", kind: "bad", when: "day", w: 5, title: "Single rider split you up",
    text: "You rode Racers separately and spent the whole thing wishing you hadn't bothered.",
    joy: -7 },
  { id: "dca_grizzly_soaked", after: ["grizzly"], park: "dca", kind: "bad", when: "day", w: 5, title: "Completely soaked on Grizzly",
    text: "Shoes included. You'll be squelching until the sun gets round to drying you.",
    joy: -4, comfort: -18 },
  { id: "dca_incredi_stall", after: ["incredicoaster"], park: "dca", kind: "bad", when: "day", w: 4, title: "Held on the Incredicoaster brake run",
    text: "Ten minutes stopped in the sun, strapped in, listening to the safety loop.",
    joy: -6, comfort: -10, minutesLost: 10 },
  { id: "dca_carsland_heat", land: "Cars Land", from: 660, to: 1020, park: "dca", kind: "bad", when: "day", w: 6, title: "There is no shade in Cars Land",
    text: "It's a desert themed to look like a desert and it is doing an excellent job.",
    joy: -3, energy: -6, comfort: -15 },
  { id: "dca_pier_wind", land: "Paradise Gardens", from: 1020, to: 1440, park: "dca", kind: "bad", when: "day", w: 4, title: "The wind came up off the water",
  ...
  { id: "dca_lamplight_full", from: 960, to: 1260, park: "dca", kind: "bad", when: "day", w: 4, title: "Lamplight has nothing until nine",
    ...
    joy: -7, minutesLost: 8 },
  { id: "dca_woc_spray", after: ["woc"], park: "dca", kind: "bad", when: "day", w: 4, title: "You were in the World of Color splash zone",
    text: "Nobody tells you which rows those are until it's much too late.",
    joy: -3, comfort: -14 },
  { id: "dca_avengers_queue", land: "Avengers Campus", park: "dca", kind: "bad", when: "day", w: 5, title: "The whole of Avengers Campus queued at once",
    text: "Something let out and every line in the land doubled in about four minutes.",
    joy: -4, comfort: -5, waitMult: 1.35, minutes: 55 },
  { id: "dca_bakery_closed", land: "San Fransokyo", from: 1080, to: 1440, park: "dca", kind: "bad", when: "day", w: 3, title: "The Bakery Tour has stopped for the day",
    text: "No sourdough, no free sample, and the smell is still coming out of the vents.",
    joy: -5 },
  { id: "dca_swings_wind", land: "Paradise Gardens", from: 1020, to: 1440, park: "dca", kind: "bad", when: "day", w: 3, title: "Silly Symphony Swings shut for wind",
    text: "Along with the Zephyr and the Jellyfish. Half of Paradise Gardens is standing still.",
    joy: -5 },
  { id: "dca_hollywood_empty", land: "Hollywood Land", park: "dca", kind: "bad", when: "day", w: 3, title: "Hollywood Land feels half-finished",
    text: "A lot of shuttered frontage and not much going on behind it.",
    joy: -5, comfort: -3 },
  { id: "dca_sanfran_lost", land: "San Fransokyo", park: "dca", kind: "bad", when: "day", w: 3, title: "You went round San Fransokyo twice",
    text: "Everything is at an angle and none of it points where you expect.",
    joy: -3, energy: -6, comfort: -4, minutesLost: 9 },
  { id: "dca_lagoon_walk", land: "Pixar Pier", park: "dca", kind: "bad", when: "day", w: 5, title: "The long way round the lagoon",
    text: "You can see where you want to be. Getting there is most of a mile.",
    joy: -3, energy: -10, comfort: -8, minutesLost: 12 },
  { id: "dca_cone_out", after: ["cozy"], park: "dca", kind: "bad", when: "day", w: 3, title: "Cozy Cone is out of the good one",
    text: "Just the plain cones left, and a queue for those.",
    joy: -5, minutesLost: 7 },
  { id: "dca_web_low", after: ["webslingers"], park: "dca", kind: "bad", when: "day", w: 4, title: "Your WEB SLINGERS score was humiliating",
    text: "Beaten comprehensively by a seven-year-old in the next seat.",
    joy: -5, energy: -4 },
  { id: "dca_guardians_scream", after: ["guardians"], park: "dca", kind: "bad", when: "day", w: 4, title: "The child next to you screamed the whole drop sequence",
    text: "Directly into your ear, at a pitch you didn't know was possible.",
    joy: -6, comfort: -4 },
  { id: "dca_pier_crush", land: "Pixar Pier", from: 1080, to: 1320, park: "dca", kind: "bad", when: "day", w: 5, title: "Pixar Pier at parade time",
    text: "One narrow boardwalk, everyone on it, and nobody moving in the same direction.",
    joy: -5, energy: -4, comfort: -8, minutesLost: 8 },
  { id: "dca_soarin_smell", after: ["soarin"], park: "dca", kind: "bad", when: "day", w: 3, title: "The Soarin' scent effect misfired",
    text: "Orange grove, then nothing, then a great deal of orange grove all at once.",
    joy: -4 },
  ...
  { id: "dca_photopass_missed", land: "Cars Land", from: 1140, to: 1440, park: "dca", kind: "bad", when: "day", w: 3, title: "The Cars Land photographer had packed up",
    text: "You came back for it specially and the spot is empty.",
    joy: -5, energy: -3, minutesLost: 8 },
  { id: "dca_mermaid_stop", after: ["mermaid"], park: "dca", kind: "bad", when: "day", w: 3, title: "Stopped inside Little Mermaid",
    text: "Under the Ursula scene, with the lights up. It is much less impressive lit.",
    joy: -4, minutesLost: 6 },
  { id: "dca_trolley_full", park: "dca", kind: "bad", when: "day", w: 3, title: "The Red Car Trolley is full",
    text: "And it's the last one before it stops for the parade.",
    joy: -3, energy: -5, minutesLost: 6 },
];
...
export default function HappiestPlace() {
  ...
  /* Some events only make sense in context: the skipper being on form needs you
     to have just ridden Jungle Cruise, and Cars Land having no shade needs you
     to be standing in Cars Land. `after` and `land` gate those. */
  function eventFits(e, atTime, just) {
    if (e.park && e.park !== pos.park) return false;
    if (e.from !== undefined && (M(atTime) < e.from || M(atTime) > e.to)) return false;
    if (e.after) return !!just && e.after.includes(just.id);
    if (e.land) return (just ? just.landName : pos.landName) === e.land;
    return true;
  }

  function fireEvent(when, atTime, just) {
    if (when === "day" && Math.random() < 0.42 && CHOICES.some((e) =>
        (!magical || e.options.every(optionIsKind)) && eventFits(e, atTime, just))) {
      const pool = CHOICES.filter((e) => (!magical || e.options.every(optionIsKind))
        && eventFits(e, atTime, just));
    ...
    const pool = EVENTS.filter((e) => e.when === when
      && (!magical || e.kind === "good") && eventFits(e, atTime, just));
    const total = pool.reduce((x, e) => x + e.w, 0);
    let roll = Math.random() * total;
    const ev = pool.find((e) => (roll -= e.w) <= 0) || pool[0];
    if (!ev) return;
  ...
  function finishRun(r, net) {
    ...
    if ((!isCustom || custom.events !== "off") && now - lastEvent.current > 55 && Math.random() < 0.34) {
      setTimeout(() => fireEvent("day", now, a), 700);   // `a` is what you just did
    }
  }
