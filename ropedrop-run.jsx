...
const EVENTS = [
  ...
  { id: "birthday", park: "dl", kind: "good", when: "day", w: 4, title: "Free celebration button",
  ...
  { id: "dl_skipper", park: "dl", kind: "good", when: "day", w: 6, title: "Your Jungle Cruise skipper is on form",
    text: "Every pun lands. The boat is in bits. You'd pay to see it again.",
    joy: 11 },
  { id: "dl_hatbox", park: "dl", kind: "good", when: "day", w: 4, title: "The Hatbox Ghost was working",
  ...
  { id: "dl_partners", park: "dl", kind: "good", when: "day", w: 4, title: "Partners with nobody in the way",
    ...
    joy: 10 },
  { id: "dl_smallworld_clock", park: "dl", kind: "good", when: "day", w: 4, title: "The clock struck as you arrived",
    text: "The whole face opens up and the parade of hours goes by. Perfect timing, entirely by accident.",
    joy: 8 },
  { id: "dl_trooper", park: "dl", kind: "good", when: "day", w: 5, title: "A Stormtrooper decided you looked suspicious",
    text: "Two minutes of being interrogated in front of a delighted crowd. You held up well.",
    joy: 11 },
  { id: "dl_frontrow_pirates", park: "dl", kind: "good", when: "day", w: 5, title: "Front row on Pirates",
    text: "You take the drop full in the face and come up laughing.",
    joy: 9, comfort: -3 },
  { id: "dl_backrow_thunder", park: "dl", kind: "good", when: "day", w: 5, title: "Back row on Big Thunder",
  ...
  { id: "dl_toontown_gag", park: "dl", kind: "good", when: "day", w: 3, title: "You found a gag nobody else was pulling",
  ...
  { id: "dl_teacups", park: "dl", kind: "bad", when: "day", w: 4, title: "Someone spun the teacup too hard",
    text: "You didn't want it that fast and your stomach is still catching up.",
    joy: -4, energy: -6, fuel: -8 },
  { id: "dl_strollers", park: "dl", kind: "bad", when: "day", w: 5, title: "A wall of strollers in Fantasyland",
  ...
  { id: "dl_pirates_soaked", park: "dl", kind: "bad", when: "day", w: 4, title: "You got the wet seat on Pirates",
    ...
    joy: -3, comfort: -12 },
  { id: "dl_hat", park: "dl", kind: "bad", when: "day", w: 3, title: "Your hat went over the side of Big Thunder",
  ...
  { id: "dl_photo_fail", park: "dl", kind: "bad", when: "day", w: 3, title: "The PhotoPass shot didn't take",
    ...
    joy: -6, minutesLost: 8 },
  { id: "dl_matterhorn_rough", park: "dl", kind: "bad", when: "day", w: 4, title: "The Matterhorn found every seam in the track",
  ...
  { id: "dca_racers_win", park: "dca", kind: "good", when: "day", w: 6, title: "Your car won the race",
    ...
    joy: 12 },
  { id: "dca_soarin_front", park: "dca", kind: "good", when: "day", w: 5, title: "Front row on Soarin'",
    text: "No feet dangling in your eyeline for once. It's a completely different ride.",
    joy: 10, comfort: 6 },
  { id: "dca_grizzly_dry", park: "dca", kind: "good", when: "day", w: 4, title: "You came off Grizzly bone dry",
  ...
  { id: "dca_luigi", park: "dca", kind: "good", when: "day", w: 4, title: "Luigi's cars actually dance",
    ...
    joy: 7 },
  { id: "dca_mater", park: "dca", kind: "good", when: "day", w: 3, title: "You got the good Mater song",
    text: "There are several and this is the one worth having.",
    joy: 6 },
  { id: "dca_web_highscore", park: "dca", kind: "good", when: "day", w: 5, title: "You topped the car on WEB SLINGERS",
    text: "Both arms aching, entirely worth it, and you have the screen to prove it.",
    joy: 11, energy: -5 },
  { id: "dca_spidey", park: "dca", kind: "good", when: "day", w: 5, title: "The Spider-Man stunt landed clean",
    text: "Straight up the side of the building and over. Nobody quite believes what they've seen.",
    joy: 10 },
  { id: "dca_avengers_char", park: "dca", kind: "good", when: "day", w: 4, title: "Loki held court in Avengers Campus",
    text: "Fully in character, entirely unbothered by the queue forming, and very funny.",
    joy: 11, minutesLost: 10 },
  { id: "dca_bakery_sample", park: "dca", kind: "good", when: "day", w: 5, title: "Free sourdough at the end of the tour",
    text: "Still warm. You take two and nobody says anything.",
    joy: 7, fuel: 12, comfort: 3 },
  { id: "dca_ghirardelli", park: "dca", kind: "good", when: "day", w: 5, title: "The chocolate square is still free",
  ...
  { id: "dca_animation", park: "dca", kind: "good", when: "day", w: 4, title: "You drew a passable Mickey",
    text: "Twenty minutes in the cool and dark, and you're taking the paper home.",
    joy: 9, energy: 8, comfort: 14, minutesLost: 20 },
  { id: "dca_crush", park: "dca", kind: "good", when: "day", w: 5, title: "Crush picked you out",
    text: "A full conversation in front of a hundred people. You did not have anything clever ready.",
    joy: 12, comfort: 10 },
  { id: "dca_geyser", park: "dca", kind: "good", when: "day", w: 4, title: "The Grizzly geyser caught the raft behind",
  ...
  { id: "dca_zephyr", park: "dca", kind: "good", when: "day", w: 3, title: "Golden Zephyr at the right hour",
    text: "It only runs when the wind is calm, and the view out over the water is worth the wait.",
    joy: 7, comfort: 4 },
  { id: "dca_wharf_short", park: "dca", kind: "good", when: "day", w: 4, title: "No queue at the wharf",
    text: "Every counter open at once. You eat properly for the first time today.",
    joy: 8, fuel: 26, comfort: 8, money: -17, minutesLost: 18 },
  { id: "dca_monsters_taxi", park: "dca", kind: "good", when: "day", w: 3, title: "The taxi driver knew your name",
    text: "They read it off your bag and worked it into the spiel. Small thing, well done.",
    joy: 7 },
  { id: "dca_pier_gull_standoff", park: "dca", kind: "good", when: "day", w: 3, title: "You out-stared a gull",
    text: "It considered your churro at length, thought better of it, and left.",
    joy: 6 },
  { id: "dca_split", park: "dca", kind: "bad", when: "day", w: 5, title: "Single rider split you up",
    text: "You rode Racers separately and spent the whole thing wishing you hadn't bothered.",
    joy: -7 },
  { id: "dca_grizzly_soaked", park: "dca", kind: "bad", when: "day", w: 5, title: "Completely soaked on Grizzly",
  ...
  { id: "dca_hollywood_empty", park: "dca", kind: "bad", when: "day", w: 3, title: "Hollywood Land feels half-finished",
    ...
    joy: -5, comfort: -3 },
  { id: "dca_sanfran_lost", park: "dca", kind: "bad", when: "day", w: 3, title: "You went round San Fransokyo twice",
    text: "Everything is at an angle and none of it points where you expect.",
    joy: -3, energy: -6, comfort: -4, minutesLost: 9 },
  { id: "dca_lagoon_walk", park: "dca", kind: "bad", when: "day", w: 5, title: "The long way round the lagoon",
    text: "You can see where you want to be. Getting there is most of a mile.",
    joy: -3, energy: -10, comfort: -8, minutesLost: 12 },
  { id: "dca_cone_out", park: "dca", kind: "bad", when: "day", w: 3, title: "Cozy Cone is out of the good one",
    text: "Just the plain cones left, and a queue for those.",
    joy: -5, minutesLost: 7 },
  { id: "dca_web_low", park: "dca", kind: "bad", when: "day", w: 4, title: "Your WEB SLINGERS score was humiliating",
