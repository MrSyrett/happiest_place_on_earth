...
self.addEventListener("fetch", (e) => {
  ...
  // the map comes from the repo, so check the network first and fall back to cache
  if (/map\.(jpg|jpeg|png|webp)$/i.test(new URL(e.request.url).pathname)) {
