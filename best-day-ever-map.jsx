...
const DL_RAW = [
  ["railroad", "Disneyland Railroad", "Main Street", "ride", "B", 20, 10, 7, -2, 0, 0, 594, 682],
  ["cinema", "Main Street Cinema", "Main Street", "show", "A", 10, 0, 4, 2, 0, 0, 582, 638],
  ["jolly", "Jolly Holiday Bakery", "Main Street", "dine", "—", 25, 12, 9, 10, 30, 16, 567, 596],
  ["emporium", "The Emporium", "Main Street", "shop", "—", 15, 0, 12, -2, 0, 48, 609, 644],
  ["parade", "Electrical Parade", "Main Street", "night", "E", 25, 20, 18, -2, 0, 0, 594, 623],
  ["fireworks", "Fireworks over the Castle", "Central Plaza", "night", "E", 25, 30, 28, -4, 0, 0, 595, 413],

  ["indy", "Indiana Jones Adventure", "Adventureland", "ride", "E", 5, 45, 20, -8, 0, 0, 483, 558],
  ["jungle", "Jungle Cruise", "Adventureland", "ride", "D", 12, 35, 13, -3, 0, 0, 501, 535],
  ["treehouse", "Adventureland Treehouse", "Adventureland", "ride", "B", 12, 5, 7, -6, 0, 0, 486, 577],
  ["tiki", "Enchanted Tiki Room", "Adventureland", "show", "B", 17, 10, 9, 8, 0, 0, 521, 564],
  ["bengal", "Bengal Barbecue", "Adventureland", "dine", "—", 20, 10, 10, 8, 28, 14, 508, 548],

  ["pirates", "Pirates of the Caribbean", "New Orleans Sq.", "ride", "D", 15, 30, 16, 2, 0, 0, 410, 529],
  ["mansion", "Haunted Mansion", "New Orleans Sq.", "ride", "D", 12, 38, 16, 0, 0, 0, 377, 497],
  ["bayou", "Blue Bayou Restaurant", "New Orleans Sq.", "dine", "—", 75, 20, 26, 25, 55, 72, 397, 524],
  ["julep", "Mint Julep Bar", "New Orleans Sq.", "dine", "—", 12, 12, 8, 4, 14, 9, 414, 514],

  ["tiana", "Tiana's Bayou Adventure", "Critter Country", "ride", "E", 12, 53, 19, -6, 0, 0, 295, 434],
  ["pooh", "Winnie the Pooh", "Critter Country", "ride", "C", 5, 15, 7, 2, 0, 0, 272, 405],
  ["bear", "Hungry Bear Restaurant", "Critter Country", "dine", "—", 25, 12, 11, 10, 30, 19, 311, 420],

  ["rise", "Rise of the Resistance", "Galaxy's Edge", "ride", "E", 18, 64, 24, -10, 0, 0, 322, 154],
  ["falcon", "Smugglers Run", "Galaxy's Edge", "ride", "E", 8, 36, 16, -4, 0, 0, 381, 189],
  ["oga", "Oga's Cantina", "Galaxy's Edge", "dine", "—", 30, 25, 18, 6, 10, 34, 351, 200],
  ["ronto", "Ronto Roasters", "Galaxy's Edge", "dine", "—", 18, 12, 10, 8, 26, 17, 376, 204],

  ["thunder", "Big Thunder Mountain", "Frontierland", "ride", "E", 8, 40, 18, -7, 0, 0, 476, 307],
  ["twain", "Mark Twain Riverboat", "Frontierland", "ride", "C", 18, 12, 10, 12, 0, 0, 375, 374],
  ["horseshoe", "Golden Horseshoe Revue", "Frontierland", "show", "B", 22, 5, 11, 10, 0, 0, 470, 446],
  ["fantasmic", "Fantasmic!", "Frontierland", "night", "E", 30, 45, 30, -8, 0, 0, 418, 422],

  ["matterhorn", "Matterhorn Bobsleds", "Fantasyland", "ride", "E", 8, 45, 16, -9, 0, 0, 695, 319],
  ["peterpan", "Peter Pan's Flight", "Fantasyland", "ride", "D", 6, 36, 14, -2, 0, 0, 576, 332],
  ["smallworld", "it's a small world", "Fantasyland", "ride", "C", 16, 20, 11, 10, 0, 0, 618, 250],
  ["alice", "Alice in Wonderland", "Fantasyland", "ride", "C", 7, 30, 9, -1, 0, 0, 638, 332],
  ["toad", "Mr. Toad's Wild Ride", "Fantasyland", "ride", "C", 4, 25, 8, -1, 0, 0, 586, 325],
  ["snow", "Snow White's Enchanted Wish", "Fantasyland", "ride", "C", 5, 25, 8, -1, 0, 0, 559, 342],
  ["teacups", "Mad Tea Party", "Fantasyland", "ride", "C", 5, 25, 9, -5, 0, 0, 653, 317],
  ["storybook", "Storybook Land Canal Boats", "Fantasyland", "ride", "B", 10, 20, 9, 6, 0, 0, 659, 279],

  ["railway", "Mickey & Minnie's Runaway Railway", "Toontown", "ride", "E", 10, 40, 19, -3, 0, 0, 647, 107],
  ["roger", "Roger Rabbit's Car Toon Spin", "Toontown", "ride", "D", 6, 30, 11, -3, 0, 0, 609, 102],
  ["gadget", "Gadget's Go Coaster", "Toontown", "ride", "B", 3, 20, 6, -2, 0, 0, 624, 122],

  // --- classic Disneyland food & treats ---
  ["corndog", "Little Red Wagon Corn Dog", "Main Street", "dine", "—", 15, 25, 15, 6, 26, 13, 580, 623],
  ["gibson", "Gibson Girl Ice Cream Parlor", "Main Street", "dine", "—", 12, 15, 11, 4, 16, 9, 588, 635],
  ["candy", "Candy Palace Candy Apple", "Main Street", "dine", "—", 8, 8, 9, 2, 12, 11, 601, 633],
  ["plazainn", "Plaza Inn Fried Chicken", "Main Street", "dine", "—", 45, 18, 20, 18, 48, 34, 611, 606],
  ["carnation", "Carnation Café", "Main Street", "dine", "—", 40, 20, 17, 16, 42, 30, 576, 617],
  ["popcorn", "Popcorn Cart", "Main Street", "dine", "—", 6, 5, 7, 2, 10, 7, 597, 652],

  ["dolewhip", "Dole Whip at Tiki Juice Bar", "Adventureland", "dine", "—", 12, 20, 17, 6, 18, 8, 529, 566],
  ["hideaway", "The Tropical Hideaway", "Adventureland", "dine", "—", 18, 12, 12, 8, 24, 14, 515, 537],

  ["beignets", "Mickey Beignets", "New Orleans Sq.", "dine", "—", 12, 14, 15, 5, 20, 10, 418, 508],
  ["monte", "Café Orleans Monte Cristo", "New Orleans Sq.", "dine", "—", 50, 22, 21, 18, 46, 38, 404, 518],
  ["chowder", "Royal Street Veranda Chowder", "New Orleans Sq.", "dine", "—", 15, 10, 12, 8, 26, 14, 406, 537],

  ["harbour", "Harbour Galley Lobster Roll", "Bayou Country", "dine", "—", 18, 12, 13, 8, 26, 18, 322, 428],

  ["rancho", "Rancho del Zocalo", "Frontierland", "dine", "—", 30, 14, 14, 12, 36, 22, 485, 441],
  ["funnel", "Stage Door Café Funnel Cake", "Frontierland", "dine", "—", 12, 12, 13, 4, 20, 11, 467, 438],
  ["turkeyleg", "Turkey Leg Cart", "Frontierland", "dine", "—", 10, 8, 13, 6, 30, 15, 456, 413],

  ["maurice", "Maurice's Treats", "Fantasyland", "dine", "—", 10, 12, 11, 4, 18, 10, 563, 348],
  ["redrose", "Red Rose Taverne", "Fantasyland", "dine", "—", 25, 15, 13, 10, 32, 20, 552, 338],
  ["edelweiss", "Edelweiss Snacks", "Fantasyland", "dine", "—", 8, 8, 10, 4, 22, 12, 678, 330],

  ["milkstand", "Blue Milk at the Milk Stand", "Galaxy's Edge", "dine", "—", 10, 16, 13, 4, 12, 9, 360, 183],

  ["pizzaplanet", "Alien Pizza Planet", "Tomorrowland", "dine", "—", 25, 14, 12, 10, 34, 19, 802, 505],
  ["daisy", "Café Daisy", "Toontown", "dine", "—", 15, 10, 9, 8, 24, 14, 634, 118],

  ["space", "Space Mountain", "Tomorrowland", "ride", "E", 8, 58, 21, -8, 0, 0, 736, 571],
  ["startours", "Star Tours", "Tomorrowland", "ride", "D", 12, 35, 14, -5, 0, 0, 758, 537],
  ["buzz", "Buzz Lightyear Astro Blasters", "Tomorrowland", "ride", "C", 8, 25, 10, -2, 0, 0, 773, 508],
  ["nemo", "Finding Nemo Submarines", "Tomorrowland", "ride", "C", 15, 35, 10, 4, 0, 0, 762, 411],
  ["autopia", "Autopia", "Tomorrowland", "ride", "C", 10, 40, 8, -2, 0, 0, 800, 344],
  ["orbitor", "Astro Orbitor", "Tomorrowland", "ride", "B", 5, 25, 7, -3, 0, 0, 777, 480],
  ["grill", "Galactic Grill", "Tomorrowland", "dine", "—", 20, 10, 9, 8, 28, 16, 791, 495],
];

const DCA_RAW = [
  ["carthay", "Carthay Circle Restaurant", "Buena Vista St.", "dine", "—", 70, 18, 24, 22, 52, 68, 590, 953],
  ["trolley", "Red Car Trolley", "Buena Vista St.", "ride", "B", 8, 8, 6, 4, 0, 0, 596, 931],
  ["fiddler", "Fiddler, Fifer & Practical Café", "Buena Vista St.", "dine", "—", 18, 10, 8, 8, 24, 13, 611, 920],

  ["monsters", "Monsters, Inc. Mike & Sulley", "Hollywood Land", "ride", "C", 6, 20, 9, -1, 0, 0, 764, 954],
  ["philhar", "Mickey's PhilharMagic", "Hollywood Land", "show", "C", 14, 15, 11, 8, 0, 0, 739, 931],
  ["animation", "Animation Academy", "Hollywood Land", "show", "B", 30, 10, 12, 12, 0, 0, 752, 920],

  ["webslingers", "WEB SLINGERS", "Avengers Campus", "ride", "D", 6, 45, 14, -3, 0, 0, 704, 1030],
  ["guardians", "Guardians of the Galaxy", "Avengers Campus", "ride", "E", 7, 55, 21, -9, 0, 0, 647, 1006],
  ["pym", "Pym Test Kitchen", "Avengers Campus", "dine", "—", 25, 15, 13, 10, 32, 24, 726, 1015],

  ["racers", "Radiator Springs Racers", "Cars Land", "ride", "E", 8, 75, 25, -6, 0, 0, 647, 1211],
  ["mater", "Mater's Junkyard Jamboree", "Cars Land", "ride", "C", 4, 25, 8, -4, 0, 0, 609, 1237],
  ["luigi", "Luigi's Rollickin' Roadsters", "Cars Land", "ride", "C", 4, 25, 8, -3, 0, 0, 628, 1247],
  ["flos", "Flo's V8 Café", "Cars Land", "dine", "—", 22, 12, 11, 9, 30, 18, 599, 1218],
  ["cozy", "Cozy Cone Motel", "Cars Land", "dine", "—", 10, 8, 7, 4, 16, 11, 615, 1227],

  ["ghirardelli", "Ghirardelli Soda Fountain", "San Fransokyo", "dine", "—", 18, 14, 12, 6, 20, 15, 504, 1159],
  ["lamplight", "Lamplight Lounge", "Pixar Pier", "dine", "—", 55, 22, 20, 18, 44, 52, 379, 1206],

  ["incredicoaster", "Incredicoaster", "Pixar Pier", "ride", "E", 5, 40, 19, -9, 0, 0, 303, 1245],
  ["palaround", "Pixar Pal-A-Round", "Pixar Pier", "ride", "D", 12, 40, 13, -1, 0, 0, 254, 1203],
  ["midway", "Toy Story Midway Mania", "Pixar Pier", "ride", "D", 7, 40, 14, -2, 0, 0, 351, 1256],
  ["critter", "Jessie's Critter Carousel", "Pixar Pier", "ride", "B", 4, 15, 6, 0, 0, 0, 274, 1226],
  ["whirlwind", "Inside Out Emotional Whirlwind", "Pixar Pier", "ride", "C", 5, 20, 8, -2, 0, 0, 322, 1218],

  ["mermaid", "Little Mermaid", "Paradise Gardens", "ride", "C", 6, 15, 9, 4, 0, 0, 322, 1126],
  ["skyschool", "Goofy's Sky School", "Paradise Gardens", "ride", "D", 4, 30, 10, -6, 0, 0, 293, 1141],
  ["swings", "Silly Symphony Swings", "Paradise Gardens", "ride", "C", 5, 20, 9, -3, 0, 0, 351, 1126],
  ["zephyr", "Golden Zephyr", "Paradise Gardens", "ride", "B", 4, 15, 6, -1, 0, 0, 370, 1136],
  ["jellyfish", "Jumpin' Jellyfish", "Paradise Gardens", "ride", "A", 3, 15, 5, -1, 0, 0, 332, 1145],

  ["soarin", "Soarin' Over California", "Grizzly Peak", "ride", "E", 12, 45, 20, 2, 0, 0, 437, 1006],
  ["grizzly", "Grizzly River Run", "Grizzly Peak", "ride", "E", 8, 40, 17, -8, 0, 0, 472, 971],
  ["redwood", "Redwood Creek Challenge Trail", "Grizzly Peak", "ride", "B", 20, 0, 8, -10, 0, 0, 418, 958],
  ["smokejumpers", "Smokejumpers Grill", "Grizzly Peak", "dine", "—", 20, 12, 9, 8, 28, 17, 456, 1006],

  // --- California Adventure food & treats ---
  ["schmoozies", "Schmoozies Smoothies", "Hollywood Land", "dine", "—", 10, 10, 9, 6, 16, 10, 748, 964],
  ["wieners", "Award Wieners", "Hollywood Land", "dine", "—", 15, 12, 11, 6, 26, 15, 756, 946],
  ["jackjack", "Jack-Jack Cookie Num Nums", "Pixar Pier", "dine", "—", 8, 14, 13, 3, 16, 8, 291, 1235],
  ["snowman", "Adorable Snowman Frosted Treats", "Pixar Pier", "dine", "—", 10, 12, 12, 4, 18, 9, 274, 1216],
  ["angrydogs", "Angry Dogs", "Pixar Pier", "dine", "—", 12, 10, 10, 5, 24, 13, 314, 1227],
  ["gardengrill", "Paradise Garden Grill", "Paradise Gardens", "dine", "—", 20, 12, 12, 10, 30, 18, 341, 1111],
  ["bayside", "Bayside Brews", "Paradise Gardens", "dine", "—", 10, 8, 8, 4, 12, 11, 368, 1141],
  ["lucky", "Lucky Fortune Cookery", "San Fransokyo", "dine", "—", 18, 12, 11, 8, 26, 16, 513, 1149],
  ["poultry", "Poultry Palace", "Pixar Pier", "dine", "—", 14, 10, 10, 6, 26, 14, 332, 1252],

  ["woc", "World of Color", "Paradise Bay", "night", "E", 25, 45, 29, -6, 0, 0, 398, 1157],
];

const LAST_CALL = { rise: 840, twain: 660, redwood: 720 };  // minutes from 8 AM
...
function waitFor(a, t, crowd, weather) {
  ...
  const w = a.wait * dayCurve(a.id, a.ticket, t) * crowd * jitter * wx * fw;
...
function walkMinutes(pos, a) {
  ...
  const base = Math.max(2, Math.round(d / UNITS_PER_MIN) + 2);
...
const ANCHORS = {
  dl: [
    { label: "Sleeping Beauty Castle", hint: "the blue castle at the centre of the park", x: 595, y: 356 },
    { label: "Space Mountain", hint: "the big white ribbed dome in Tomorrowland", x: 736, y: 571 },
  ],
  dca: [
    { label: "Pixar Pal-A-Round", hint: "the Ferris wheel at Pixar Pier", x: 254, y: 1203 },
    { label: "Carthay Circle", hint: "the domed tower at the top of Buena Vista Street", x: 590, y: 953 },
  ],
};

/* Pin positions were measured directly off the official resort map, so if you
   load that same image no calibration is needed — these anchors are identity. */
const PRESET = {
  dl: [{ x: 595, y: 356 }, { x: 736, y: 571 }],
  dca: [{ x: 254, y: 1203 }, { x: 590, y: 953 }],
};
...
export default function BestDayEver() {
  ...
  const [joy, setJoy] = useState(58);
  const [energy, setEnergy] = useState(100);
  const [fuel, setFuel] = useState(72);
  const [wallet, setWallet] = useState(300);
  const [pos, setPos] = useState({ park: "dl", x: 584, y: 780 });
  ...
  const editList = useMemo(() => ATTRACTIONS.filter((a) => a.kind !== "shop")
    .slice().sort((p, q) => (p.park === q.park ? p.landName.localeCompare(q.landName) || p.name.localeCompare(q.name) : p.park < q.park ? -1 : 1)), []);
  ...
  function loadBasemap(file) {
    ...
    r.onload = () => {
      const img = new Image();
      img.onload = () => {
        setBasemap({ src: r.result, w: img.width, h: img.height });
        const official = Math.abs(img.height / img.width - CANVAS_H / CANVAS_W) < 0.035;
  ...
  function start() {
    const rolls = ["clear", "clear", "hot", "drizzle"];
    setSeed({ crowd: 0.8 + Math.random() * 0.55, weather: rolls[Math.floor(Math.random() * rolls.length)] });
    setScreen("play"); setT(OPEN); setJoy(58); setEnergy(100); setFuel(72); setWallet(300);
    setPos({ park: "dl", x: 584, y: 780 }); setMapPark("dl"); setVisited({});
    setLl(0); setBoughtLl(false); setLog([]); setTab("map"); setSel(null); setCat("ride");
  }

  const waits = useMemo(() => {
    const w = {};
    for (const a of ATTRACTIONS) w[a.id] = waitFor(a, t, seed.crowd, seed.weather);
    return w;
  }, [t, seed]);
  ...
  const visible = useMemo(() => ATTRACTIONS.filter((a) => {
    ...
    if (cat === "ride" && a.kind !== "ride") return false;
  ...
  function passTime(mins) {
    ...
    setEnergy((e) => clamp(e - (mins / 10) * 0.3 * hot));
    setFuel((f) => clamp(f - (mins / 10) * 0.95));
    setJoy((j) => clamp(j - (mins / 10) * 0.35));
    setT((x) => x + mins);
  }

  /* One minute of an activity. Kept pure so the same maths drives both the
     live tick and the Skip button. */
  function minuteDelta(r, i, hot) {
    const { a, walk, wait, dur } = r;
    const phase = i < walk ? "walk" : i < walk + wait ? "wait" : "do";
    let dJoy = -0.035, dEn = -0.03 * hot, dFu = -0.095;
    if (phase === "walk") { dEn -= 0.45 * hot; dJoy -= 0.05; }
    if (phase === "wait") { dEn -= 0.06; dJoy -= r.painRate; }
    if (phase === "do") {
      dJoy += r.gain / dur;
      dEn += (a.en > 0 ? a.en : a.en * hot) / dur;
      dFu += a.fuel / dur;
    }
    return { dJoy, dEn, dFu, phase };
  }

  function beginAttraction(raw, useLL) {
    const a = place(raw);
    if (run || a.cost > wallet) return;
    const walk = walkMinutes(pos, a);
    const wait = useLL ? 5 : waits[a.id];
    ...
    setMapPark(a.park);
    setRun({
      a, useLL, walk, wait, dur: Math.max(1, a.dur), painRate, gain, reps,
  ...
  function stepMinute() {
    ...
    const { dJoy, dEn, dFu, phase } = minuteDelta(r, r.i, hot);

    setT((x) => x + 1);
    setJoy((j) => clamp(j + dJoy));
    setEnergy((e) => clamp(e + dEn));
    setFuel((f) => clamp(f + dFu));

    if (phase === "walk" && r.walk > 0) {
      const p = (r.i + 1) / r.walk;
      setPos({ park: p > 0.5 ? r.a.park : r.from.park, x: r.from.x + (r.a.x - r.from.x) * p, y: r.from.y + (r.a.y - r.from.y) * p });
    }
  ...
  function skipRun() {
    ...
    for (let i = r.i; i < total; i++) {
      const d = minuteDelta(r, i, hot);
      dJ += d.dJoy; dE += d.dEn; dF += d.dFu;
    }
    setT((x) => x + (total - r.i));
    setJoy((j) => clamp(j + dJ));
  ...
  const rest = {
    bench: () => { passTime(20); setEnergy((e) => clamp(e + 20)); setJoy((j) => clamp(j - (energy < 40 ? 0 : 3))); push("Found a bench. Watched the crowd go by.", "ok"); },
    churro: () => { if (wallet < 7) return; passTime(10); setWallet((w) => w - 7); setFuel((f) => clamp(f + 12)); setEnergy((e) => clamp(e + 4)); setJoy((j) => clamp(j + 5)); push("Churro. $7. Worth it.", "good"); },
    coffee: () => { if (wallet < 6) return; passTime(12); setWallet((w) => w - 6); setEnergy((e) => clamp(e + 12)); setFuel((f) => clamp(f + 5)); setJoy((j) => clamp(j + 2)); push("Cold brew. Second wind.", "ok"); },
    wander: () => { passTime(25); setEnergy((e) => clamp(e - 5)); setJoy((j) => clamp(j - 4)); push("Wandered around not doing much. The day is slipping by.", "bad"); },
    ll: () => { if (wallet < 32 || boughtLl) return; setWallet((w) => w - 32); setLl(5); setBoughtLl(true); setJoy((j) => clamp(j - 2)); push("Bought Lightning Lane Multi Pass — 5 skips, $32", "ok"); },
  };
  ...
  if (screen === "title") return <Title onStart={() => setScreen("setup")} />;
  if (screen === "end")
    return <End joy={joy} t={t} wallet={wallet} energy={energy} visited={visited} seed={seed} onAgain={start} />;
  ...
  return (
    <Shell>
      <StatusBar t={t} joy={joy} energy={energy} fuel={fuel} wallet={wallet} ll={ll} seed={seed} />
      ...
      {tab === "you" && <YouTab rest={rest} wallet={wallet} ll={ll} boughtLl={boughtLl}
        energy={energy} fuel={fuel} joy={joy} visited={visited} />}
      {tab === "setup" && (
        <div style={{ flex: 1, overflowY: "auto", background: C.gap }}>
          <Card>
            <div style={{ fontSize: 15.5, color: C.grey, lineHeight: 1.5, marginBottom: 12 }}>
              {basemap ? "Playing on your own map image." : "Playing on the built-in map."}
            </div>
            <input ref={setupFile} type="file" accept="image/*" style={{ display: "none" }}
              onChange={(e) => { const f = e.target.files && e.target.files[0]; if (f) loadBasemap(f); e.target.value = ""; }} />
            <Row>
            ...
            {basemap && Object.values(PARKS).map((p) => (
              <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 14 }}>
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 700, color: C.navy, fontSize: 15.5 }}>{p.name}</div>
                  <div style={{ fontSize: 14, color: transforms[p.id] ? C.green : C.red, fontWeight: 600 }}>
                    {transforms[p.id] ? "Calibrated" : `${anchors[p.id].length}/2 points placed`}
                  </div>
                </div>
          ...
          <Card>
            ...
            <Row>
              <Pill solid onClick={() => { setEditing(true); setEditIdx(0); setTab("map"); }}>
                {Object.keys(nudges).length ? "Continue adjusting" : "Start adjusting"}
              </Pill>
              {Object.keys(nudges).length > 0 && (
                <Pill onClick={() => setNudges({})}>Reset all</Pill>
              )}
            </Row>
            {Object.keys(nudges).length > 0 && (
              <>
                <Note tone="good">{Object.keys(nudges).length} of {ATTRACTIONS.filter((a) => a.kind !== "shop").length} repositioned.</Note>
                <div style={{ fontSize: 14.5, color: C.grey, marginTop: 14, lineHeight: 1.5 }}>
                  Send this back to me and I'll bake the corrections into the game permanently:
                </div>
                <textarea readOnly onFocus={(e) => e.target.select()}
                  value={"const FIXED = {\n" + Object.entries(nudges).map(([k, v]) => `  "${k}": [${v.x}, ${v.y}],`).join("\n") + "\n};"}
                  style={{
                    width: "100%", height: 130, marginTop: 8, padding: 10, boxSizing: "border-box",
                    border: `1px solid ${C.border}`, borderRadius: 10, background: C.gap,
                    fontFamily: "ui-monospace, Menlo, monospace", fontSize: 12.5, color: C.text, resize: "vertical",
                  }} />
              </>
            )}
          </Card>
      ...
      {selA && !calib && !editing && !run && (
        <Sheet a={selA} wait={waits[selA.id]} walk={walkMinutes(pos, place(selA))}
          ...
          onClose={() => setSel(null)} onGo={beginAttraction} />
      )}
...
function ParkMap({ park, items, waits, pos, sel, onSelect, visited, basemap, transforms, calib, anchors, onAnchor, calibWarn, onCancelCalib, showBoth,
                  editing, editTarget, onPlacePin, editIdx, editCount, nudged, onEditStep, onEditDone }) {
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", background: "#DCE6EA", touchAction: "none" }}
      ...
      <svg viewBox={`0 0 ${CANVAS_W} ${H}`} preserveAspectRatio="xMidYMid slice"
        ...
        <g ref={layer} transform={`translate(500 ${H / 2}) scale(${safe(v.k, 1)}) translate(${-safe(v.cx, 500)} ${-safe(v.cy, H / 2)})`}>
          ...
          {!calib && !editing && pos.park === park && (() => {
            const p = fitted ? applyT(transforms[pos.park], pos.x, pos.y) : pos;
            if (!isFinite(p.x)) return null;
            return (
              <g transform={`translate(${p.x} ${p.y}) scale(${pinK})`} style={{ pointerEvents: "none" }}>
                <circle r="19" fill={C.blue} opacity=".18" />
                <circle r="9" fill={C.blue} stroke={C.white} strokeWidth="3.5" />
              </g>
            );
          })()}
          ...
          {!calib && shown.map((a) => {
            ...
            return <MapPin key={a.id} a={a} px={p.x} py={p.y} w={waits[a.id]} pinK={safe(pinK, 1)}
              ...
              onTap={() => { if (moved.current) return; if (editing) onPlacePin({ x: a.x, y: a.y }); else onSelect(a.id); }} />;
          })}
        </g>
      </svg>

      {!calib && (
        <button onClick={recenter} aria-label="Centre on me" style={{
      ...
      {editing && editTarget && (
        <div style={{
          position: "absolute", left: 12, right: 12, top: 12, background: C.white,
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
            <div style={{ fontSize: 12, letterSpacing: ".08em", fontWeight: 800, color: C.blue, textTransform: "uppercase" }}>
              {editIdx + 1} of {editCount} · {nudged} moved
            </div>
...
function MapPin({ a, px, py, w, pinK, selected, done, dim, nameLabel, onTap }) {
  ...
  const bg = selected ? C.blue : C.white;
  const fg = selected ? C.white : C.navy;
  return (
    <g transform={`translate(${px} ${py}) scale(${pinK})`} onClick={(e) => { e.stopPropagation(); onTap(); }}
      opacity={dim ? 0.42 : 1} style={{ cursor: "pointer" }}>
      {nameLabel && selected && (
        <>
...
function Shell({ children }) {
  return (
    <div style={{ background: "#0E1B26", display: "flex", justifyContent: "center", minHeight: "100vh" }}>
      <div style={{
        width: "100%", maxWidth: 440, background: C.white, height: "100vh",
...
function StatusBar({ t, joy, energy, fuel, wallet, ll, seed }) {
  return (
    <div style={{ padding: "10px 16px 11px", borderBottom: `1px solid ${C.rule}`, flexShrink: 0, background: C.white }}>
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 9 }}>
          <span style={{ fontSize: 21, fontWeight: 800, color: C.navy }}>{clock(t)}</span>
          <span style={{ fontSize: 13.5, color: C.greyLt, fontWeight: 600 }}>
            {WEATHERS[seed.weather].label} · {seed.crowd > 1.15 ? "Packed" : seed.crowd > 0.95 ? "Busy" : "Light"}
          </span>
        </div>
        <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
          ...
          <span style={{ fontSize: 19, fontWeight: 800, color: C.green }}>${Math.max(0, Math.round(wallet))}</span>
        </div>
      </div>
      <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
        <Meter label="Joy" v={joy} c={C.pink} />
        <Meter label="Energy" v={energy} c={C.amber} />
        <Meter label="Fed" v={fuel} c={C.green} />
      </div>
    </div>
  );
}
...
function Meter({ label, v, c }) {
  return (
    <div style={{ flex: 1 }}>
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11.5, fontWeight: 700, color: C.greyLt }}>
        <span>{label}</span><span style={{ color: C.text }}>{Math.round(v)}</span>
      </div>
      <div style={{ height: 5, borderRadius: 3, background: C.rule, marginTop: 3, overflow: "hidden" }}>
...
function CatTabs({ cat, setCat }) {
  return (
    <div style={{ display: "flex", padding: "10px 4px 8px", borderBottom: `1px solid ${C.rule}`, flexShrink: 0, background: C.white }}>
      {CATS.map((c) => {
        const on = cat === c.id;
        return (
          <button key={c.id} onClick={() => setCat(c.id)} style={{
            ...
            <span style={{
              width: 40, height: 40, borderRadius: 20, background: on ? C.blueTint : "transparent",
              display: "flex", alignItems: "center", justifyContent: "center",
            }}><Icon d={c.icon} c={on ? C.blue : C.navy} f={c.icon === "star" && on} s={23} /></span>
            <span style={{ fontSize: 12.5, fontWeight: on ? 800 : 600, color: on ? C.blue : C.navy }}>{c.label}</span>
          </button>
        );
      })}
    </div>
...
function FilterRow({ mapPark, setMapPark, eOnly, setEOnly, hideDone, setHideDone, onReset }) {
  return (
    <div style={{
      display: "flex", gap: 8, padding: "10px 12px", overflowX: "auto", flexShrink: 0,
...
const Chip = ({ on, onClick, children }) => (
  <button onClick={onClick} style={{
    padding: "7px 15px", borderRadius: 20, whiteSpace: "nowrap", cursor: "pointer",
    border: `1.5px solid ${on ? C.blue : C.border}`, background: on ? C.blue : C.white,
    color: on ? C.white : C.navy, fontFamily: F, fontSize: 14.5, fontWeight: 700,
  }}>{children}</button>
);
    ...
    <div style={{ background: C.white, padding: "16px 16px 18px", marginBottom: 10 }}>
      <div style={{ display: "flex", gap: 12 }}>
        ...
        <div style={{
          ...
          <Icon d={a.kind === "dine" ? "fork" : isRide ? "star" : "hat"} c={C.blue} f={isRide} s={26} />
        </div>
      </div>
      ...
      <InfoBox>
        <div>
          <div style={{ fontSize: 15.5, fontWeight: 800, color: C.navy }}>
            {a.kind === "dine" ? "Table Wait" : isRide ? "Standby Line" : "Next Show"}
          </div>
      ...
      <div style={{ marginTop: 12 }}>
        <BigButton disabled={broke} onClick={() => onGo(a, false)}>
          {broke ? "Not enough money" : a.kind === "dine" ? `Eat Here${a.cost ? ` · $${a.cost}` : ""}` : isRide ? "Join Standby Line" : "Go Watch"}
        </BigButton>
      </div>
    </div>
  );
...
/* ---------------- detail sheet ---------------- */
function Sheet({ a, wait, walk, hop, reps, wallet, ll, llOk, t, onClose, onGo }) {
  const canLL = ll > 0 && llOk && wait > 15;
  const broke = a.cost > wallet;
...
function ActivityRunner({ run, speed, setSpeed, onSkip }) {
  ...
  const seg = [["Walk", walk], [a.kind === "dine" ? "Table" : "Line", wait], [a.kind === "dine" ? "Meal" : "Ride", dur]];
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
        <div style={{
          ...
          <Icon d={phase === "walk" ? "locate" : phase === "wait" ? "clock" : a.kind === "dine" ? "fork" : isRide ? "star" : "hat"}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 13 }}>
        <div style={{ flex: 1, fontSize: 15, fontWeight: 800, color: net >= 0 ? C.green : C.red }}>
          {net >= 0 ? "+" : ""}{net.toFixed(1)} joy so far
        </div>
        {[1, 2, 4, 8].map((sp) => (
          <button key={sp} onClick={() => setSpeed(sp)} style={{
            minWidth: 38, padding: "6px 8px", borderRadius: 16, cursor: "pointer",
            border: `1.5px solid ${speed === sp ? C.blue : C.border}`,
            background: speed === sp ? C.blue : C.white, color: speed === sp ? C.white : C.navy,
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 16, fontWeight: 800, color: C.navy, marginTop: 1 }}>
        {name} <span style={{ color: bad ? C.red : C.green }}>{net >= 0 ? "+" : ""}{net.toFixed(1)} joy</span>
      </div>
    </div>
  );
}
...
function YouTab({ rest, wallet, ll, boughtLl, energy, fuel, joy, visited }) {
  const advice =
    ...
    : joy < 40 ? "The day's gotten away from you. Go do something big."
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: C.gap }}>
      ...
      <Card>
        <div style={{ fontSize: 17, fontWeight: 800, color: C.navy, marginBottom: 12 }}>Take a break</div>
        <Row>
          <Pill onClick={rest.bench}>Sit down · 20 min</Pill>
          <Pill onClick={rest.churro}>Churro · $7</Pill>
          <Pill onClick={rest.coffee}>Cold brew · $6</Pill>
          <Pill onClick={rest.wander}>Wander · 25 min</Pill>
        </Row>
      </Card>
      <Card>
        ...
        {boughtLl ? (
          ...
          <>
            ...
            <BigButton disabled={wallet < 32} onClick={rest.ll}>Buy for $32</BigButton>
          </>
        )}
      </Card>
    </div>
      ...
      {items.map(([id, ic, label]) => {
        ...
        return (
          <button key={id} onClick={() => !disabled && setTab(id)} style={{
            ...
            opacity: disabled && !on ? .4 : 1, padding: "9px 0 8px",
            display: "flex", flexDirection: "column", alignItems: "center", gap: 3,
          }}>
            <Icon d={ic} c={on ? C.blue : C.greyLt} f={on && (ic === "pin" || ic === "home")} s={22} />
            <span style={{ fontSize: 11, fontWeight: on ? 800 : 600, color: on ? C.blue : C.greyLt }}>{label}</span>
          </button>
        );
      })}
    </div>
    ...
    <Shell>
      <div style={{ flex: 1, overflowY: "auto", padding: "52px 24px 30px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16.5, lineHeight: 1.55, color: C.text, maxWidth: 330, margin: "0 auto 22px" }}>
          ...
          Rides, food and shows lift your joy. Long lines, dead time, sore feet and sticker shock pull it back down.
        </p>
        ...
        <BigButton onClick={onStart}>Plan the Day</BigButton>
      </div>
    </Shell>
  );
}

function End({ joy, t, wallet, energy, visited, seed, onAgain }) {
  ...
  const final = clamp(joy + Math.min(8, unique * 0.4) + (wallet > 0 ? 2 : 0) + (both ? 3 : 0));
  const rank =
    final >= 92 ? ["Best Day Ever", C.pink] : final >= 80 ? ["A truly magical day", C.blue] :
    final >= 66 ? ["A great day", C.blue] : final >= 50 ? ["A good day", C.navy] :
    final >= 34 ? ["A perfectly fine day", C.navy] : ["You should've stayed at the hotel", C.grey];
  return (
    <Shell>
      <div style={{ flex: 1, overflowY: "auto", padding: "44px 24px 30px", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 78, fontWeight: 800, color: rank[1], lineHeight: 1.05, margin: "10px 0 2px" }}>{Math.round(final)}</div>
        ...
        <div style={{ background: C.gap, borderRadius: 14, padding: "6px 16px", textAlign: "left", maxWidth: 340, margin: "0 auto 26px" }}>
          {[["Attractions ridden", rides], ["Different things tried", unique], ["Both parks", both ? "Yes (+3)" : "No"],
            ["Money left", `$${Math.max(0, Math.round(wallet))}`], ["Energy remaining", `${Math.round(energy)}%`],
            ["Conditions", `${WEATHERS[seed.weather].label}, ${seed.crowd > 1.15 ? "packed" : seed.crowd > 0.95 ? "busy" : "light"}`]]
            .map(([k, val]) => (
